...
## Project Structure
    ...
    ├── restless_hill_dev_78488  # Django project configurations
...
1. Clone this repo and `cd restless_hill_dev_78488`
...
2. Clone this repo and `cd restless_hill_dev_78488`
