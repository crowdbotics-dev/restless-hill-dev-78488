"""
Django settings for restless_hill_dev_78488 project.
...
ROOT_URLCONF = 'restless_hill_dev_78488.urls'
...
WSGI_APPLICATION = 'restless_hill_dev_78488.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_hill_dev_78488 API",
    "DESCRIPTION": "API documentation for restless_hill_dev_78488 App",
    "VERSION": "v1",
}
